...
/** Public entry for the is-sim lab; sends students into their class context. */
export function IsSimRedirectPage() {
  ...
  const hidden = catalog?.get("is-sim")?.hidden === true;
  ...
  useEffect(() => {
    ...
    if (classId && (role === "admin" || (catalog !== null && !hidden))) {
      void navigate({ to: "/classes/$classId/labs/is-sim", params: { classId } });
    }
